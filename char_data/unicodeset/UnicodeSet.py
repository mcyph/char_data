...
def UnicodeSet(s, char_data=None, char_indexes=None):
    """
    ...
    token = get_unicode_set_ranges(s, char_indexes=char_indexes)
    return unicode_set_from_token(token, char_indexes=char_indexes)
...
def unicode_set_from_token(i, char_data=None, char_indexes=None):
    """
