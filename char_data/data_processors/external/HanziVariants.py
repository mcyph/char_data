...
from char_data.data_processors.external.property_formatters.hanzi_variants import JaSimplified
from char_data.data_processors.external.property_formatters.hanzi_variants import CEDictVariants
