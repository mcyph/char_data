...
class SimilarHanzi:
    ...
    def raw_data(self, ord_):
        ...
        if char in DBothChars:
            ...
            LNumStrokes = raw_data('unihan.totalstrokes', ord_) or []
            #print LNumStrokes
    ...
    def _get_cmp_value(self, LRads, LNumStrokes, ord_):
        ...
        #print unichr(ord_), raw_data('unihan.totalstrokes', ord_)
        for num_strokes in raw_data('unihan.totalstrokes', ord_) or []:
    ...
    def formatted(self, ord_):
        return ' '.join(w_unichr(i_ord) for i_ord in self.raw_data(ord_))
